...
Sau đó truy cập vào github : https://github.com/Hungkute123/FE-BLOCKCHAIN và tải về
Sau khi giải nén, mở trong visual studio code và chọn Terminal -> New Terminal
Sau đó nhấn "npm install"
Sau đó nhấn "npm run dev"

Sau khi quá trình hoàn tất truy cập vào Url: http://localhost:3000/wallet/create